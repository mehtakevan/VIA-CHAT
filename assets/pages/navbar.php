        ...
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand" href="?">
                    <img src="assets/images/Via_chat.png" alt="" width="150" height="40">   
                </a>

                <form class="d-flex" id="searchform">
                    <input class="form-control" type="search" id="search" placeholder="Search Username..."
...
<p class="text-center text-muted">Enter name or username</p>
            ...
            <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-0 mb-sm-0" style="font-size: 1.4em;">
                <li class="nav-item">
    ...
    <?php
                ...
                <li class="nav-item dropdown dropstart">
                    <a class="nav-link" href="#" id="navbarDropdown" role="button"
                        ...
                        <img src="assets/images/profile/<?=$user['profile_pic']?>" alt="" height="42" width="42" class="rounded-circle border">
                    </a>
